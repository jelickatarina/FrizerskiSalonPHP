...
else 
{
  ...
  {
    $poruka="";
    $sql = "select * from korisnik where KorisnikId='".$korisnik."'";
    ...
    if($data=$result->fetch_assoc())  { 
      ...
      die("Ne mogu da proadjem korisnika:".$korisnik);
  }
?> 
<!DOCTYPE html>
<html lang="en">
...
<form method="post" class="forma">
    ...
    <h5 style="color:#FF0000;"><?=$poruka?><h5>
      <table>
        ...
        <tr>
          <td>Lozinka:</td>
          <td><input type="text" name="lozinka" value="<?=$lozinka?>"></td>
        </tr>
        <tr>
          <td>Ime:</td>
